...
import { saveProduct } from '../app/functions'
...
export default function AddProduct() {
  ...
  return (
        <>
           <div className=" font-bold px-6 py-4 shadow-lg rounded-md border-2 border-indigo-300 m-5 text-3xl text "> Add Product
           </div>
           <div className='container'>
           <div className=" mt-2 flex justify-center content-center">
          
            <form onSubmit={handleSaveProduct} className=" shadow-lg flex flex-col px-6 py-6 w-1/2  border-2 border-indigo-300 rounded-lg">
            <h2 className='text-3xl font-bold text-center mb-6 underline '> Product informations:</h2>
              ...
              <div className="mb-2 flex justify-center content-center h-6 ">
                <input checked={checked} onChange={(e)=> setChecked(e.target.value)} value={checked} id="check" name="check" type="checkbox" className="mt-2 mx-1 h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-600"/>
